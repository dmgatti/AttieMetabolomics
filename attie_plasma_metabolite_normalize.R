################################################################################
# Normalize and impute missing data in the Attie plasma metabolite data set.
# Daniel Gatti
# dan.gatti@jax.org
# Nov 15, 2017
################################################################################
...
metab = read_delim(paste0(input.dir, "formatted_data/FilterdbyR_DOPlasmaMetbolites_BatchandCovariatesAppended.txt"),
        delim = "\t")
...
pdf("figures/plasma_metabolites_unnormalized_PCA.pdf")
...
saveRDS(data.rz, file = paste0(output.dir, "attie_plasma_metabolites_zscore_normalized.rds"))


# Make PCA plots of the normalized data, colored by batch, sex, etc.
pdf("figures/plasma_metabolites_normalized_PCA.pdf", width = 12, height = 7)
...
pdf("figures/plasma_metabolites_normalized_boxplot.pdf", width = 12, height = 7)
boxplot(data, range = 0)
dev.off()

pdf("figures/plasma_metabolites_normalized_heatmap.pdf", width = 12, height = 12)
