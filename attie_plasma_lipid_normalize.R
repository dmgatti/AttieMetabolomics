...
lipid = read_delim(paste0(input.dir, "formatted_data/21June2017_DOPlasmaLipidomicsRaw.txt"),
        delim = "\t")
...
norm = read.delim("/hpcdata/gac/raw/Attie_DO_Liver_Metabolomics/formatted_data/15June2017_DOPlasmaLipidomics.txt")
