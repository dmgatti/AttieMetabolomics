...
lipid = read_delim(paste0(input.dir, "formatted_data/03_January_2018_DO_Plasma_Lipidomics_Raw.txt"),
        delim = "\t")
...
boxplot(scores(pc.data)[,1] ~ annot$batch)
...
norm = read.delim("/hpcdata/gac/raw/Attie_DO_Metabolomics/formatted_data/15June2017_DOPlasmaLipidomics.txt")
...
pdf("figures/plasma_lipids_UWisc_normalized_PCA.pdf", width = 12, height = 7)
